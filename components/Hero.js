    ...
    <section class="bg-gray-900 p-10 md:p-12">
      <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
          ...
          <a
            href="#pricing"
            class="inline-flex items-center justify-center px-9 py-3 text-base font-medium text-center border rounded-lg focus:ring-4 text-white border-gray-700 hover:bg-gray-700 focus:ring-gray-800"
          >
            Pricing
          </a>
        </div>
