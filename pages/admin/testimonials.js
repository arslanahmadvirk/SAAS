...
export default function Testimonials() {
  ...
  const handleRoute = () => {
    router.push("/admin/addtestimonial");
  };
          ...
          <tbody>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
              ...
              <td className="py-4 px-6">
                ...
                incidunt quis dignissimos earum error, voluptas omnis sunt nam
                inventore, fuga saepe quidem libero aut aliquid ad quod!
                Deleniti, consequuntur suscipit.
              </td>
              <td className="py-4 px-6">
                <button
                  type="button"
