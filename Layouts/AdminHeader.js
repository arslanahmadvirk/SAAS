...
export default function AdminHeader() {
  return (
    <header>
      <nav className="bg-white border-gray-200 px-4 lg:px-6  dark:bg-gray-800 pt-10">
        <div className="flex flex-wrap justify-between items-center">
          <div className="flex justify-start items-center">
            <button
              ...
              className="hidden p-2 mr-3 text-gray-600 rounded cursor-pointer lg:inline hover:text-gray-900 hover:bg-gray-100  dark:hover:text-white dark:hover:bg-gray-700"
            >
              <svg
                className="w-6 h-6"
                fill="currentColor"
